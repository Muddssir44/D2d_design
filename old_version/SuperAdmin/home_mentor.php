        ...
        <div class="col-12">
            <table class="table" style="margin-block-start: -20px;font-size: 1.0rem;">
				...
				?>
					...
					<tr> 
						<td><a href="viewteams.php?team_id=<?php echo $r_team['team_id']?>&mentor_id=<?php echo $id?>"><?php echo $r_team['project_name']?></a></td> 
						<td><a href="viewteams.php?team_id=<?php echo $r_team['team_id']?>&mentor_id=<?php echo $id?>"><?php echo $r_team['project_description']?></a></td> 
						<td><a href="viewteams.php?team_id=<?php echo $r_team['team_id']?>&mentor_id=<?php echo $id?>"><?php echo $r_team['category']?></a></td> 
						...
						<?php if (($year) == date("Y")) { ?>
						<td>
						<a href="viewteams.php?team_id=<?php echo $team_id?>&mentor_id=<?php echo $id?>"><button type="button" style="margin:0px;"  class="btn-success btn-sm"  onclick="edit(this)">Edit</button></a>
						<a href="edit_team.php?team_id=<?php echo $team_id?>&mentor_id=<?php echo $id?>"><button type="button" style="margin:0px;"  class="btn-success btn-sm"  onclick="edit(this)">Upload Files</button></a>
						<a onClick="return confirm('Are you sure you want to delete?')" href="set_delete.php?id=<?php echo $team_id?>&table=tbl_team&mentor_id=<?php echo $id;?>" class="btn mini purple"> Delete</a>
						</td> 
						<?php } ?>
						</td> 
				    </tr> 
