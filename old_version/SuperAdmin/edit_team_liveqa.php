...
$l_q = mysqli_query($con,"select distinct live_qa from tbl_judge_assessment where team_id = '$team_id'");
...
if(isset($_POST['submit']))
{
	...
	if($update)
	{
		...
		#echo $r;
		echo "<script type='text/javascript'> document.location = 'liveqa_teams.php'; </script>";
	}
	else 
	{
