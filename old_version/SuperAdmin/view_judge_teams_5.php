	...
	<?php include('navbar.php');?>
		...
		<br>
            <table class="table" id="myTable" style="margin-block-start: -11px">
				...
				$q_team = mysqli_query($con,"select  distinct user_id, GROUP_CONCAT(team_id) as team_list ,count(*) as count from tbl_judge_team where year = '$year' group by (user_id) having count(user_id) = 5");	
