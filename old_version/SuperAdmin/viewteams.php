...
#echo "<script type='text/javascript'>window.location.href = 'home_mentor.php';</script>";	
...
<div class="container d-flex justify-content-left col-md-12">
        <div class="col-12" id="editDetails">
			...
			<tr>
				...
				<a href="edit_team.php?team_id=<?php echo $team_id; ?>&mentor_id=<?php echo $mentor_id;?>"><button type="submit" class="btn btn-success" name="submit">Edit video pitch/logbook</button></a>	
          ...
          <table class="table table-borderless" style="<?php if($c_students > 0) { echo 'margin-top:-175px'; } else { echo 'margin-top:-10px'; }?>">
				...
				?>
							...
							<tr>
								...
								<td>
								<label>Edit</label>
								<a href="edit_member_details.php?student_id=<?php echo $row['id']; ?>&mentor_id=<?php echo $mentor_id;?>"><button type="submit" class="btn btn-success" name="submit">Edit</button></a>	
								<a onClick="return confirm('Are you sure you want to delete?')" href="set_delete.php?id=<?php echo $row['id'];?>&table=tbl_team_member&mentor_id=<?php echo $mentor_id;?>" class="btn btn-success"> Delete</a>
