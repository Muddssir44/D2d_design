...
if($list){
    ...
    #$q = "SELECT * FROM tbl_team WHERE id not in ($list) and category = '$cat' and year = '$year' and deleted = 0 ORDER BY project_team_name ASC";
    //Count total number of rows
   
        echo '<option value="">Select Team-4'.$q.'</option>';
