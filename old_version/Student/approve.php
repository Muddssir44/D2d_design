...
$q = mysqli_query($con,"update tbl_student_mentor set approve = $flag where student_id = $id");
if($q)
{
	...
	$row = mysqli_fetch_assoc($query);
		...
		$message.= '<p style="color:#080;font-size:18px;">To approve/disapprove user, please click <a href="http://dare2design.eduedgetech.com/login.php">here</a> with Super Admin credentials and click on View>Users</p>';
