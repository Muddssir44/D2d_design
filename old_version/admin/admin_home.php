...
<div id="wrapper">
   <div class="jumbotron col-md-12" style="font-size: 16px;
    height: 10em;margin-block-start: -43px;">
			...
			<div class="dbox dbox--color-1" style="height: 235px;">
				...
				<div class="dbox__body" align="left">
				 <table style="margin-block-start: -43px;">
					<thead>
					<tr>
					<th align="Center"><font color="white"><h3>Community Interest:<?php echo $interest_d['count']?></h3></font></th>
					</tr>
					</thead>
					<tbody> 
					<tr>
					<td style="width:40px"><span class="dbox__title" style=" font-size: 16px;">Volunteers</span></td>
					<td style="width:175px;"><span class="dbox__title" style=" font-size: 16px;">Judges</span></td>
					<td style="width:120px;"><span class="dbox__title" style=" font-size: 16px;">Teams</span></td>
					<td style="width:40px;"><span class="dbox__title" style=" font-size: 16px;">Mentors</span></td>
					</tr>
					<tr>
					<td style="width:40px"><span class="dbox__count"><?php echo $volunteer_d['count']?></span></td>
			...
			<div class="dbox dbox--color-1">
				...
				<div class="dbox__body" align="left" style="height:235px">
				 <table style="margin-block-start: -43px;">
					<thead>
					<tr>
					<th align="Center"><font color="white"><h3>Team Submissions:<?php echo $team_d['count']?></h3></font></th>
					</tr>
					</thead>
					<tbody> 
					<tr>
					<td style="width:40px"><span class="dbox__title" style=" font-size: 13px;">Complete</span></td>
					<td style="width:175px;"><span class="dbox__title" style=" font-size: 13px;">Incomplete</span></td>
					<td style="width:120px;"><span class="dbox__title" style=" font-size: 13px;">W/t LogBooks</span></td>
					<td style="width:40px;"><span class="dbox__title" style=" font-size: 13px;">W/t Videos</span></td>
					</tr>
					<tr>
			...
			<div class="dbox dbox--color-2" style="height: 367px;margin-block-start: -7px;">
				...
				<div class="dbox__body" align="left">
				 <table style="margin-block-start: -43px;">
					...
					<th align="Center"><font color="white"><h3>Confirmed Judges:<?php echo $conf_j_d['count'];?></h3></font></th>
					</tr>
					</thead>
					<tbody align="center"> 
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Professionals</span></td>
					<td><span class="dbox__title" style="font-size:16px">Faculty</span></td>
					<td><span class="dbox__title" style="font-size:16px">Pre-Service Teachers</span></td>
					</tr>
					...
					<tr>
					<td><span class="dbox__title" style="font-size:16px">K-12 Teachers</span></td>
					<td><span class="dbox__title" style="font-size:16px">Student</span></td>
					<td><span class="dbox__title" style="font-size:16px">Others</span></td>
					</tr>
			...
			<div class="dbox dbox--color-2" style="height: 367px;margin-block-start: -7px;">
				...
				<div class="dbox__body" align="left">
				 <table style="margin-block-start: -43px;">
					<thead>
					<tr>
					<th align="Center"><font color="white"><h3>Teams Allocation to Judges:<?php echo $count_k;?></h3></font></th>
					</tr>
					</thead>
					<tbody> 
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams with less than 3 Judges</span></td>
					<td><span class="dbox__count"><?php echo $count_2k?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams with 3 Judges</span></td>
					<td><span class="dbox__count"><?php echo $count_3k?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams with 4 Judges</span></td>
			...
			<div class="dbox dbox--color-2" style="height: 367px;margin-block-start: -7px;">
				...
				<div class="dbox__body" align="left">
				 <table style="margin-block-start: -43px;">
					<thead>
					<tr>
					<th align="Center"><font color="white"><h3>Judges Allocation to Teams:<?php echo $count_j;?></h3></font></th>
					</tr>
					</thead>
					<tbody> 
					<tr>
					<td><span class="dbox__title" style="font-size:16px">3 Teams</span></td>
					<td><span class="dbox__count"><?php echo $count_3j?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">4 Teams</span></td>
					<td><span class="dbox__count"><?php echo $count_4j?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">5 Teams</span></td>
			...
			<div class="dbox dbox--color-3" style="background: cornflowerblue;margin-block-start: -7px;">
				...
				<div class="dbox__body" style="align:left">
				 <table style="margin-block-start: -43px;">
					...
					<tbody align="center"> 
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Judges With 1 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp1_j?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Judges With 2 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp2_j?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Judges With 3 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp3_j?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Judges With 4 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp4_j?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Judges With 5 incomplete Evaluation</span></td>
			...
			<div class="dbox dbox--color-3" style="background: cornflowerblue;margin-block-start: -7px;">
				...
				<div class="dbox__body" style="align:left">
				 <table style="margin-block-start: -43px;">
					...
					<tbody align="center"> 
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams With 1 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp1_t?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams With 2 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp2_t?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams With 3 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp3_t?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams With 4 incomplete Evaluation</span></td>
					<td><span class="dbox__count"><?php echo $count_comp4_t?></span></td>
					</tr>
					<tr>
					<td><span class="dbox__title" style="font-size:16px">Teams With 5 incomplete Evaluation</span></td>
