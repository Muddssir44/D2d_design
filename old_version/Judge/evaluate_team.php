...
if(isset($_POST['submit']))
{
	...
	$insert = mysqli_query($con,"insert into tbl_judge_assessment (team_id,user_id) values ($team_id,$id)");
	...
	$question_asked = mysqli_real_escape_string($con,$question_asked);	
			...
			$r = "update tbl_judge_assessment set
									...
									question_asked = '$question_asked' where id = $iid";
	...
	{
		$del = mysqli_query($con,"delete from tbl_judge_assessment where id = $iid");
				...
				?>
												...
												<tr> 
													...
													<?php if ($r_team['log_book']!='') {?>
															<td><a href="http://emuinvent.emuem.org/<?php echo $r_team['log_book']?>" target="_blank">LogBook</a></td>  
													<?php } else {?>
															<td>LogBook</td>  
													<?php }?>
