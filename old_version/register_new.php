...
{
	echo "select * from tbl_user where email = '$email'";
}
}
...
function func_reg(Selectedvalue)
{
	...
	if(stud == 0)
	{
		...
		document.getElementById('mentor').required = true;
	}
	if(ans == 0)
	{
            ...
            <h3>User SignUp:</h3>
				...
				<div >
							...
							<div >
								...
								<option value="">Select</option>
								<?php $q = mysqli_query($con, "select id, first_name, last_name from tbl_user where user_type = 'Mentor' and is_approved = 1"); 
