                        ...
                        <div class="row g-4">
                            <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                ...
                                <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 150px; height: 110px;">
                                    <img src="img/fcc.png" alt="ford-logo"  style="width: 100%; height:95%;">
                                    </div>
                                    <h4 class="mb-0 pb-md-3">FORD COMMUNITY</h4>
                                </div>
                            </div>
                            <div class="col-12 wow fadeIn" data-wow-delay="0.5s">
                                <div class="text-center rounded py-5 px-4" style="box-shadow: 0 0 45px rgba(0,0,0,.08);">
                                    <div class="btn-square bg-light rounded-circle mx-auto mb-4" style="width: 150px; height: 110px;">
                                    <img src="img/toyota.png" alt="toyota-logo"  style="width: 100%; height:100%;">
                                    </div>
                                    <h4 class="mb-0">TOYOTA Driving Possibilities</h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class=" mb-5">What Our Sponsers Say About Us!</h1>
