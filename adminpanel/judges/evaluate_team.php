        ...
        <div class="main-panel">
            <div class="content-wrapper updated">
                ...
                <div class="content-wrapper-inside">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 grid-margin align-item-center justify-content-center">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        ");
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php
                                                        if ($r_team['log_book'] != '') {
                                                            // $corrected_path = str_replace('../test_upload', '../student/test_upload', $r_team['log_book']);
                                                        ?>
                                                            <td><a href="../student/test_upload/<?php echo $r_team['log_book'] ?>" target="_blank">LogBook</a></td>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <td>LogBook</td>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="" id="evaluation_team">
                                        <input type="hidden" name="user_id" value="<?php echo $id ?>">
                                        <input type="hidden" name="team_id" value="<?php echo $team_id ?>">
                                        <div class="form-group">
                                            <label>Identifying & Understanding: </label>
                                            <select name="identifying_understanding" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="designing_building" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="testing_refinging" required>
                                            <option value="" selected>Select</option><?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="value_propoition" required>
                                            <option value="" selected>Select</option> <?php
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <select name="market_potential" required>
                                            <option value="" selected>Select</option><?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="social_value" required>
                                            <option value="" selected>Select</option> <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="originality" required>
                                            <option value="" selected>Select</option>  <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="display_board" required>
                                            <option value="" selected>Select</option>   <?php
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <select name="online_pitch" required>
                                            <option value="" selected>Select</option>  <?php
                                        ...
                                        <div class="form-group ">
                                            <label for="email"> Q&A(5 Optional): </label>

                                            <textarea placeholder="Questions that are to be asked during Live Q & A" name="question_asked" required>
            ...
            <div class="col-md-6 col-sm-12">
                     ...
                     <div class="form-group">
                         <video width="500" height="400" controls>
                             <source src="<?php echo '../student/test_upload/' . $video_pitch ?>" type="video/mp4">
                             <source src="<?php echo '../student/test_upload/' . $video_pitch ?>" type="video/ogg">
                         </video>
                     </div>
                    <?php } else { ?>
                     <div class="form-group">
...
<script src="../assets/js/ajaxscript.js?v=29" type = "text/javascript"></script>
</html>
