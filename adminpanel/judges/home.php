...
<tr> 
													...
													<?php } else {?>
													<td><a href="<?php echo '../student/test_upload/'.$r_team['video_pitch']?>" target="_blank">Video Pitch</a></td> 
													<?php } 
													 if ($r_team['log_book']!='') {
                          ...
                          if($r_q_e>0) {
                            ...
                            $encode_team_id = base64_encode($r_team['team_id']);
                              $encode_judge_id =base64_encode($judge_id);
                             ?>
													<td><a href="evaluate_team.php?team_id=<?php echo $encode_team_id ?>&judge_id=<?php echo $encode_judge_id ?>"><button type="button" style="margin:0px;"  class="btn-success btn-sm"  onclick="edit(this)">Evaluate Team</button></a></td> 
													<?php 
                        }
                        ?>
												</tr> 
...
<script src="../assets/js/ajaxscript.js?v=25" type = "text/javascript"></script>
