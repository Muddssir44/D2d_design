...
<body>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        ...
                        //   $result = mysqli_query($conn, $query);
                                    ...
                                    <div class="form-group">
                                             ...
                                             <select name="team_assign_year" id="team_assign_year" class="form-select "  >
                    ...
                    ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="judge_id" name="judge_id">
                                            ...
                                            <?php
                                            $current_year=date('Y');
                                            $q_j = mysqli_query($conn, "select * from tbl_user where user_type='Judge' and judge_confirm = 'Y' and year='$current_year' order by first_name asc");
                                            while ($d_j = mysqli_fetch_assoc($q_j)) {
                                                $jid  = $d_j['id'];
                                                $s_c = mysqli_query($conn, "select count(*) as count from tbl_judge_team where user_id = $jid and year='$current_year'");
    ...
    <script src="../assets/js/ajaxscript.js?v=12" type="text/javascript"></script>
