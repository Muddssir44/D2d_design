      ...
      <button id="reloadButton" class="btn page-title-icon btn-sm text-white" onclick="window.history.back() ">Back</button>
                                                    ...
                                                    <td colspan="6">
                                                        ...
                                                        <div>
                                                            ...
                                                            <?php if (($team_m_r['photo_consent_form']) != '') { ?>
                                                                <a  class="text-primary"   href="<?php echo $team_m_r['photo_consent_form'] ?>" target="_blank">Consent Form</a>
                                                            <?php } ?>
				...
				<tr>
                    <td colspan="6">
						...
						<div >
                            <label class="m-3" for="pwd"><b>Update Video Pitch Youtube Link:</b></label>
