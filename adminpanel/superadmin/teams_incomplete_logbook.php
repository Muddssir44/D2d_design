...
<div class="card">
  ...
  from tbl_team tt where category = '$category' and year='$current_year' and log_book is NULL and deleted=0");	
  }
  else
  {
      $q_team = mysqli_query($conn,"SELECT distinct tt.id as team_id,tt.project_team_name as project_name,tt.project_description,tt.category,tt.video_pitch, tt.log_book
  from tbl_team tt where log_book is NULL and year='$current_year'  and deleted=0");	
  }
