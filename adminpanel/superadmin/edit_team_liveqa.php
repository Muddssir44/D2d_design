                                        ...
                                        ");
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if ($r_team['log_book'] != '') {
                                                        ?>
                                                            <td><a href="../student/<?php echo $r_team['log_book']; ?>" target="_blank">LogBook</a></td>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <td>LogBook</td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table team_table update_table">
                                            ...
                                            <tbody>
                                                ...
                                                $q_team1 = mysqli_query($conn, 
                                                "select distinct question_asked from tbl_judge_assessment where team_id = '$team_id'
                                        ");
$i=1;
                                                while ($r_team1 = mysqli_fetch_assoc($q_team1)) {
                                                    
                                                ?>

                                                    <tr>
                                                        <td><?php echo $i ?></td>
                                                        <td><?php echo $r_team1['question_asked']; ?></td>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card" style="height: min-content;">
                                <div class="card-body mt-2 pt-2">
                                    ...
                                    <h4 class="form-heading">Inventor Communicator</h4>
                                    <form class="forms-sample" id="edit_team_liveqa">
                                        
                                        <input type="hidden" name="teamid" value="<?php echo $team_id ?>">
                                        <div class="form-group">
                                        <label for="liveaqa" ><h4> Live Pitch and Q&A Score(5):</h4></label>
