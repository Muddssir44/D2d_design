                ...
                <div class="card ">
                  ...
                  <?php 
                            ...
                            from tbl_team tt");
                                 ...
                                 $query = "SELECT DISTINCT Year
                                   ...
                                   $result = mysqli_query($conn, $query);
                                             ...
                                             ?> 
                                 <div class="d-flex justify-content-between mx-2 mt-2 mb-0 px-2">
                                           ...
                                           <div class="d-flex justify-content-between">
                                             ...
                                             <select name="year_change_liveaqa" id="year_change_liveaqa" class="form-select form-select-sm ms-3" style="width: fit-content;" >
                        ...
                        <?php } ?>
                                         ...
                                         <div class=" mx-2 mt-0 px-2" >Total: <span id="total"><?php echo $no_rows ?></span></div>
...
<script src="../assets/js/ajaxscript.js?v=15" type = "text/javascript"></script>
