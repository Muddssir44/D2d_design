  ...
  <div class="col-12 grid-margin">
    <div class="card">
      ...
      <div class="d-flex justify-content-between mx-2 mt-2 mb-0">
        <h4 class="card-title">Current Evaluation Result</h4>
        <a href="previous_evaluation.php"><button id="reloadButton" class="btn page-title-icon btn-sm text-white mb-3">Previous Evaluations</button></a>
</div>
        <div class="table-responsive">
          <table class="table team_table table1">
            ...
            <?php
            $current_year=date('Y');
             $q_team = mysqli_query($conn,"select team_id, tt.project_team_name as project_name, tt.category, avg(total) as total
             from tbl_team tt, stut_tot st
             where tt.id = st.team_id
             and tt.year='$current_year'
             group by(team_id)
         ");	
