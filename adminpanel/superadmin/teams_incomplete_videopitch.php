...
<div class="card">
  ...
  from tbl_team tt where category = '$category' and video_pitch is null and year='$current_year'  and deleted=0");	
  }
  else
  {
      $q_team = mysqli_query($conn,"select distinct tt.id as team_id,tt.project_team_name as project_name,tt.project_description,tt.category,tt.video_pitch, tt.log_book
  from tbl_team tt where video_pitch is null and year='$current_year'  and deleted=0");	
  }
