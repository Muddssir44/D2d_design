...
<div class="row updated">
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Past Years Evaluation</h4>
        <div class="table-responsive">
          <table class="table team_table table1">
            ...
            <?php
             $q_team = mysqli_query($conn,"select team_id, tt.project_team_name as project_name,tt.year, tt.category, avg(total) as total
