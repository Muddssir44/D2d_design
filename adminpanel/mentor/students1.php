          ...
          <thead class="thead-dark bg-dark text-light" id="table">
				...
				?>
					...
					<tr> 
                        ...
                        <a onClick="return confirm('Do you want to disapprove the Student?')" href="approve.php?id=<?php echo $r_team['id']?>&flag=0" ><button type="button" style="margin:0px;"  class="btn-success btn-sm" style="margin:0px;background-color:red">Disapprove</button></a>
