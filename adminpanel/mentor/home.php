				...
				?>
					...
					<tr> 
						...
						<td><a href ="<?php echo $r_team['video_pitch']?>" target="_blank">Video Pitch</a></td> 
							<?php } else {?>
							<td><a href ="../student/test_upload/<?php echo $r_team['video_pitch']?>" target="_blank">Video Pitch</a></td> 
							<?php } ?>
							<?php } else { ?>
						<td></td> 
						<?php } if($r_team['log_book']) {  ?>
						<td><a href="../student/test_upload/<?php echo $r_team['log_book']?>">LogBook</a></td>  
						<?php } else { ?>
						<td></td>
