...
<!--        // <i class="mdi mdi-chart-line menu-icon"></i> -->
   ...
   <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic2">
        <ul class="nav flex-column sub-menu">
          ...
          Profile</a></li>
          <li class="nav-item "> <a href="https://logbook.nedscholars.org/" class=" nav-link "  >
          LogBook</a></li>
          <li class="nav-item">
      ...
      <ul class="nav flex-column sub-menu">
      <li class="nav-item "> <a href="http://brain.infoedmedia.com/" class=" nav-link "  >
      BrainStorm</a></li>
      <li class="nav-item "> <a href="http://fishbone.infoedmedia.com/" class=" nav-link "  >
      Fishbone</a></li>
 ...
 <li class="nav-item">
    <a class="nav-link" href="./../superadmin/update_content.php">
      <span class="menu-title">Update Content</span>
...
';
    ...
    echo '
      ...
      <i class="mdi mdi-book-open-page-variant menu-icon"></i></a></li>
          <li class="nav-item">
