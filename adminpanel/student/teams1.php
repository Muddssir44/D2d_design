...
$terms= 0;
$date_check = '2025-10-27 00:00:00';
echo $date;
if (($year) == date("Y")) {
    if ($date <= $date_check) {
        echo 'isnide';
        ...
        if (isset($_POST['submit_team'])) {
            ...
            if (mysqli_query($conn, "INSERT into tbl_team (project_team_name,project_description,category,country,year) values ('$team_name', '$project_description','$category','$country','$year')")) {
