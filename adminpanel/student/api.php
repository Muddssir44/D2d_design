...
class API extends DBConnection
{
    ...
    function teamselect()
    {
        ...
        if(isset($grade_row['student_grade']) && !empty($grade_row['student_grade'])){
        ...
        if ($no_of_rows > 0) {
            ...
            $content .= ' <tr>
                        <td colspan="6">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" id="studentEmail" name="team_name" required placeholder="Project Title" value="' . $row['project_team_name'] . '" required>
                            </div>
                    ...
                    <tr>
                        <td colspan="6">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" name="category" readonly placeholder="Team Name" value="' . $category . '" required>
            ...
            $content .= '<select name="student_id[]" class="form-select" multiple="multiple"><option disabled>Selecssss the Team Members</option>';
            ...
            $q_m = $this->conn->query("SELECT tbl_student_mentor.student_id as id, tbl_user.first_name, tbl_user.last_name
                                    ...
                                    -- if student has no grade defined
            ...
            $content .= ' <tr>
                <td colspan="6">
                    ...
                    <div>
                        <label for="pwd"><b>Project Title:</b></label>
                        <input type="text" class="form-control" id="studentEmail" name="team_name" required placeholder="Project Title" value="" required>
                    </div>
            ...
            <tr>
                ...
                <td colspan="6">
                    ...
                    <div>
                        <label for="studentType">Team Category:</label>
                        <input type="text" class="form-control" name="category" readonly required placeholder="Category" value="' . $category . '" required>
            ...
            <tr>
                ...
                <td colspan="6">
                    ...
                    <div>
                        <label for="studentType">Team Country:</label>
            ...
            $content ="<h1>Please Update Your Student Profile</h1>";
        }
    ...
    function create_member()
    {
        ...
        $q = "INSERT into  student 
                    (student_id, student_first_name  ,student_last_name ,student_grade  ,student_school_name  ,student_school_district  ,t_shirt_size  ,photo_consent   )
                    VALUES('$student_id','$first_name','$last_name','$student_grade','$student_school_name','$student_school_district','$student_tshirt','$photo_consent') ";
          $q1=$this->conn->query("SELECT * from student where student_id='$student_id'");
      if($q1->num_rows==0){
