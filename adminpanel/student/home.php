...
$date_check = '2025-11-27 00:00:00';
						...
						<?php 
                                ...
                                ORDER BY t.year DESC
                                 ...
                                 <div class="d-flex justify-content-between mx-2 mt-2 mb-0">
                                             <h4 class="card-title mt-1">Your Teams For <span id="year_span"><?php  echo $year ?>
                                                </span> </h4>

                                           <div class="d-flex justify-content-between">
                                             <label for="studentType " class="mt-1">Student year:</label>
                        ...
                        <?php } ?>
							...
							and tt.deleted = 0");
											...
											?>
												...
												<tr>
													<td>
														<!-- <a href="viewteams.php?team_id=<?php echo base64_encode($r_team['team_id']) ?>"><?php echo $r_team['project_name'] ?></a> -->
														<?php echo $r_team['project_name'] ?>
														
													</td>
													<td>
														<!-- <a href="viewteams.php?team_id=<?php echo base64_encode($r_team['team_id']) ?>"><?php echo $r_team['project_description'] ?></a> -->
														<?php echo $r_team['project_description'] ?>
													</td>
													<td>
														<!-- <a href="viewteams.php?team_id=<?php echo base64_encode($r_team['team_id']) ?>"><?php echo $r_team['category'] ?></a> -->
														<?php echo $r_team['category'] ?>
													</td>
													...
													<?php if (($year) ==date('Y')) {
														// if ($date <= $date_check) {
															...
															<td style="display:flex; flex-direction:column;">
																...
																<a href="viewteams.php?team_id=<?php echo $encoded_team_id ?>"><button type="button" style="margin:2px;" class="btn-success btn-sm m-1" onclick="edit(this)">Edit</button></a>
																<a href="edit_team.php?team_id=<?php echo $encoded_team_id ?>"><button type="button" style="margin:3px;" class="btn-success btn-sm   m-1          " onclick="edit(this)">Upload Files</button></a>
