...
$previous_year =trim($_GET['previous_year']);
}else{
...
$date_check1 ='2023-11-27 00:00:00';
						...
						<?php 
                                ...
                                ORDER BY t.year DESC
                                 ...
                                 <div class="d-flex justify-content-between mx-2 mt-2 mb-0">
                                             <h4 class="card-title mt-1">Your Teams For <span id="year_span"><?php echo $previous_year ?>
                                                </span> </h4>
