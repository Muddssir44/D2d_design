...
$current_year = date("Y");
echo $current_year;
 $q = mysqli_query($conn, "select id, first_name, last_name from tbl_user where user_type = 'Mentor' and is_approved = 1 and year =$current_year   order by first_name asc");
  ...
  <script type="text/javascript" src="./assets/js/ajax.js?v=5"></script>
